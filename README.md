...
- [Задание 2. Конфигурация файлового хранилища (RAID)](module2/task2-raid.md)
- [Задание 3. Настройка сервера сетевой файловой системы (NFS)](module2/task3-nfs.md)
- [Задание 4. Настройка службы сетевого времени (Chrony)](module2/task4-ntp.md)
...
**Задание 2. Конфигурация файлового хранилища**

- Создание RAID-массива уровня 0 из двух дисков по 1 Гб
- Имя устройства: `md0`
- Файловая система: `ext4`
- Автоматическое монтирование в `/raid`

➡️ **[Подробное решение Задания 2](module2/task2-raid.md)**

**Задание 3. Настройка сервера сетевой файловой системы (NFS)**

- Папка общего доступа: `/raid/nfs`
- Доступ для чтения и записи для сети HQ-CLI
- Автомонтирование на HQ-CLI в `/mnt/nfs`

➡️ **[Подробное решение Задания 3](module2/task3-nfs.md)**

**Задание 4. Настройка службы сетевого времени (Chrony)**

- NTP-сервер на ISP со стратумом 5
- Клиенты: HQ-SRV, HQ-CLI, BR-RTR, BR-SRV

➡️ **[Подробное решение Задания 4](module2/task4-ntp.md)**
...
### Задание 2. Конфигурация файлового хранилища (RAID)

Подробная инструкция по созданию программного RAID-массива уровня 0 на HQ-SRV.

➡️ **[Перейти к инструкции](module2/task2-raid.md)**

**Краткое содержание:**
- Установка и настройка `mdadm`
- Создание RAID 0 из двух дисков по 1 Гб
- Форматирование в файловую систему ext4
- Настройка автоматического монтирования в `/raid`

### Задание 3. Настройка сервера сетевой файловой системы (NFS)

Подробная инструкция по настройке NFS-сервера на HQ-SRV и NFS-клиента на HQ-CLI.

➡️ **[Перейти к инструкции](module2/task3-nfs.md)**

**Краткое содержание:**
- Установка и настройка NFS-сервера на HQ-SRV
- Экспорт директории `/raid/nfs` для сети HQ-CLI
- Настройка NFS-клиента на HQ-CLI
- Автомонтирование в `/mnt/nfs`

### Задание 4. Настройка службы сетевого времени (Chrony)

Подробная инструкция по настройке NTP-сервера на ISP и синхронизации времени на всех устройствах.

➡️ **[Перейти к инструкции](module2/task4-ntp.md)**

**Краткое содержание:**
- Настройка NTP-сервера на ISP со стратумом 5
- Настройка NTP-клиентов на HQ-RTR, BR-RTR, HQ-SRV, HQ-CLI, BR-SRV
